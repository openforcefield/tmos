...
project = "Transition Metal Oxidation State"
copyright = (
    "2025, Jennifer A Clark. Project structure based on the "
...
man_pages = [
    (master_doc, "tmos", "Transition Metal Oxidation State Documentation", [author], 1)
]
